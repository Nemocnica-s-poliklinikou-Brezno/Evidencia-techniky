...
Public Class Vykaz_materialu
    Private Sub Vykaz_materialu_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Using cmd As New MySqlCommand("SELECT date_format(datum, GET_FORMAT(DATE,'EUR')) as 'Dátum', Cislo_ziadanky, Cislo_vydajky, Kusy, Nazov_materialu FROM etech_test.vykazmaterialu WHERE Cislo_ziadanky = '" & Ziadanky_zoznam.Poziadavka_cislo & "';")
            cmd.Connection = con
