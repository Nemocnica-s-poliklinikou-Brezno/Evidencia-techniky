    ...
    Public Sub b_VstupneData_Click(sender As Object, e As EventArgs) Handles b_VstupneData.Click
        ...
        If OpenFileDialog1.FileName Like "*.txt" Then
            ...
            While streamReader.Peek() <> -1
                ...
                QueryDUP = "SELECT id_doprava_data FROM doprava_data WHERE rok = '" & DataGridView1.Rows(i).Cells(0).Value.ToString & "' AND cislovyjazdu = '" & DataGridView1.Rows(i).Cells(1).Value.ToString & "' AND rodcis = '" & DataGridView1.Rows(i).Cells(3).Value.ToString & "' AND kodpoist = '" & DataGridView1.Rows(i).Cells(9).Value.ToString & "' AND vzdialenost = '" & DataGridView1.Rows(i).Cells(10).Value.ToString & "' AND skutocnekm = '" & DataGridView1.Rows(i).Cells(11).Value.ToString & "' AND koddiagnozy = '" & DataGridView1.Rows(i).Cells(12).Value.ToString & "' AND kodpoistodos = '" & DataGridView1.Rows(i).Cells(20).Value.ToString & "' AND kododdodos = '" & DataGridView1.Rows(i).Cells(21).Value.ToString & "' AND evidcis = '" & DataGridView1.Rows(i).Cells(22).Value.ToString & "' AND oscis = '" & DataGridView1.Rows(i).Cells(25).Value.ToString & "' AND porcisriadok = '" & DataGridView1.Rows(i).Cells(27).Value.ToString & "' and rok = year(now());"
                con.Open()
